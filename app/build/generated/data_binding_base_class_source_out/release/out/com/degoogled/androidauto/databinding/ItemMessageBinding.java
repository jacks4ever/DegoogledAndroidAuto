...
public final class ItemMessageBinding implements ViewBinding {
  ...
  private ItemMessageBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cardMessage,
  ...
  public static ItemMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageBinding((ConstraintLayout) rootView, cardMessage, textMessage,
          textTimestamp);
    }
